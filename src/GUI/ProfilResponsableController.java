...
public class ProfilResponsableController implements Initializable {
    ...
    */
    ...
    @FXML
    void lanceravis(ActionEvent event) throws IOException {
        AnchorPane pane = FXMLLoader.load(getClass().getResource("AvisResponsabe.fxml"));
        rootPane.getChildren().setAll(pane);
    }
     @FXML
    void lancerAffichE(ActionEvent event) throws IOException {
       AnchorPane pane = FXMLLoader.load(getClass().getResource("FXML_event.fxml"));
        rootPane.getChildren().setAll(pane);
    }
    
    @FXML
    void lancerSC(ActionEvent event) throws IOException {
     ...
     @FXML
    void lancerRec(ActionEvent event) throws IOException {
        AnchorPane pane = FXMLLoader.load(getClass().getResource("ListReclamation.fxml"));
        System.out.println("statistic");
        rootPane.getChildren().setAll(pane);
