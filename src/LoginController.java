    ...
    private void connecter(ActionEvent event) throws SQLException, IOException {
     ...
     User.setPassword(password);
       ...
       utilisateurService su = new utilisateurService();
        NewFXMain2 main= new NewFXMain2();
        try
 {
...
iduser=Us.getId();
 ...
 {  
     ...
     System.out.println("Parent Home");
      System.out.println(Session.getId_User());
...
Stage stage = (Stage) btnlog.getScene().getWindow();
     ...
     else if(userValide.equals("Responsable Jardin"))
 { 
 ...
 Stage stage = (Stage) btnlog.getScene().getWindow();
        ...
        try{
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("ResponsableFXML.fxml"));
            Parent root2 = (Parent) fxmlLoader.load();
            Stage stage2 = new Stage();
