...
public class ControleSaisie {
    ...
    public static boolean controleMDPVide(JFXPasswordField textField, String msg, Label errorLabel) {
        String chaine = textField.getText().trim();
        if (chaine.length() == 0) {
            errorLabel.setText(msg);
            textField.clear();
    ...
    public static boolean controleComplexiteMDP(JFXPasswordField textField, String msg, Label errorLabel) {
        String chaine = textField.getText();
        char[] tab = chaine.toCharArray();
    ...
    public static boolean controleComboBox(ComboBox<String> combo, String msg, Label errorLabel) {
    ...
    public static boolean controleTextAreaVide(JFXTextArea tArea, String msg, Label errorLabel) {
    ...
    public static boolean controleTextAreaNonNumerique(JFXTextArea tArea, String msg, Label errorLabel) {
    ...
    public static boolean controleLabelImage(Text path, String msg, Label errorLabel) {
    ...
    public static boolean controleGPS(double latitude, double longitude, String msg, Label errorLabel) {
    ...
    public static boolean controleTextFieldNumerique1(JFXTextField textField, String msg, Label errorLabel) {
        if (!textField.getText().matches(".*[a-zA-Z].*")) {
            errorLabel.setText(msg);
    ...
    public static boolean controleNumTelLongueur1(JFXTextField textField, String msg, Label errorLabel) {
        if (textField.getText().length() != 8) {
            errorLabel.setText(msg);
            return true;
        } else if (textField.getText().substring(0, 1) != "31" && textField.getText().charAt(0) != '2' && textField.getText().charAt(0) != '5' && textField.getText().charAt(0) != '9' && textField.getText().charAt(0) != '7') {
    ...
    public static boolean controleTextFieldVide1(JFXTextField textField, String msg, Label errorLabel) {
        String chaine = textField.getText().trim();
        if (chaine.length() == 0) {
            errorLabel.setText(msg);
            textField.clear();
    ...
    public static boolean controleTextFieldNonNumerique1(JFXTextField textField, String msg, Label errorLabel) {
        if (textField.getText().matches(".*[a-zA-Z].*")) {
            errorLabel.setText(msg);
    ...
    public static boolean controleTextAreaVide1(JFXTextArea tArea, String msg, Label errorLabel) {
        String chaine = tArea.getText().trim();
        if (chaine.length() == 0) {
            errorLabel.setText(msg);
            tArea.clear();
    ...
    public static boolean controleTextAreaNonNumerique1(JFXTextArea tArea, String msg, Label errorLabel) {
        if (!tArea.getText().matches(".*[a-zA-Z].*")) {
            errorLabel.setText(msg);
    ...
    public static boolean controleLabelImage1(Label path, String msg, Label errorLabel) {
        if (path.getText().equals("Sélectionner une image")) {
            errorLabel.setText(msg);
            return true;
        }
    ...
    public static boolean controleTextFieldPrix(JFXTextField textField, String msg, Label errorLabel) {
        String chaine = textField.getText();
        char[] tab = chaine.toCharArray();
    ...
    public static boolean controleComboBoxstring(JFXComboBox<String> combo, String msg, Label errorLabel) {
        if (combo.getValue() == null) {
            errorLabel.setText(msg);
            return true;
        }
