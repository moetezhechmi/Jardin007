...
public class Incident {
    ...
    public Incident(String nom, String description, int createdby) {
        this.nom = nom;
        this.description = description;
        this.createdby = createdby;
    }

    public Incident(int id_inc, String nom, String description, int createdby, Date date_inc) {
        this.id_inc = id_inc;
        this.nom = nom;
        this.description = description;
        this.createdby = createdby;
    ...
    public Incident(String nom, String description, int createdby, Date date_inc) {
        this.nom = nom;
        this.description = description;
        this.createdby = createdby;
        this.date_inc = date_inc;
