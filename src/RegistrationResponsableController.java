 ...
 * @author Khaled
 */
public class RegistrationResponsableController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
         tfrole.setText(String.valueOf("Responsable Jardin"));
...
alert.showAndWait();
        ...
        JOptionPane.showMessageDialog(null, "Responsable Jardin d'Enfant ajouté");
        tfnom.clear();
        tfprenom.clear();
        tfemail.clear();
        tflogin.clear();
